...
namespace Nupload
{
	public static class HtmlHelperExtensions
	{
		...
		public static MvcForm BeginAsyncUploadFormAlt<T>(this HtmlHelper<T> htmlHelper, Uri callbackUrl, IUploadConfiguration uploadConfiguration, object htmlAttributes = null)
		{
			var formAttributes = new Dictionary<string, string>
			{
				{ "data-post", callbackUrl.OriginalString },
				{ "enctype", "multipart/form-data" },
			}.Concat(uploadConfiguration.AltFormAttributes);
